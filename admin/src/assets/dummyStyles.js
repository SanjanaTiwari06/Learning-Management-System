export const bannerStyles = {
  ...
  // Features
 featuresGrid: "grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 animate-fade-in opacity-100 animation-delay-700",
  ...
  // Buttons
  buttonsContainer: "flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 animate-fade-in opacity-100 animation-delay-900",
